...
export default {
  ...
  methods: {
    ...
    _getData () {
      ...
      this.$axios.post(this.$store.state.G_HOST+'/app/income/extension', this.$qs.stringify({uid}))
      .then(result => {
    ...
    loadList() {
      this.page++
      let uid = localStorage.getItem('uid')
      this.$axios.post(this.$store.state.G_HOST+'/app/income/extension', this.$qs.stringify({page:this.page, uid}))
      .then(result => {
